describe("Unfollow User from Post Post Test", () => {
   ...
   cy.get('button:nth-child(2) > div > span.action-title').should('contain', 'Follow').click(); // check and click on Unfollow button in context menu
   cy.get('div#toast-container div > div').should('contain', 'Follow request has sent successfully') // check toaster message
