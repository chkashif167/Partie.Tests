describe("Unfollow User from Post Test", () => {
   ...
   cy.get('span.action-title').contains('Unfollow').click(); // check and click on Unfollow button in context menu
   cy.get('div#toast-container div > div').should('contain', 'User successfully un-followed') // check toaster message
