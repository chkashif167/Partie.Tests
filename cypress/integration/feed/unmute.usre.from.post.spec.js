describe("Un-Mute User from Post Test", () => {
   ...
   cy.get('span.action-title').contains('Unmute').click(); // check and click on Unfollow button in context menu
   cy.get('div#toast-container div > div').should('contain', 'User successfully un-muted')
